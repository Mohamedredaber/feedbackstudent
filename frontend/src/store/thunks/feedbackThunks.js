  ...
  async (coursTitle, { rejectWithValue }) => {
    try {
      const response = await api.get(
        `/feedback/${encodeURIComponent(coursTitle)}`,
      );
      return response.data;
    } catch (error) {
      return rejectWithValue(
        error.response?.data?.message || "Failed to fetch course feedbacks",
      );
    }
  },
);
...
export const fetchStudentFeedbacks = createAsyncThunk(
  ...
  async (_, { rejectWithValue }) => {
    try {
      ...
      return rejectWithValue(
        error.response?.data?.message || "Failed to fetch student feedbacks",
      );
    }
  },
);
...
export const addFeedback = createAsyncThunk(
  ...
  async ({ courseId, data }, { rejectWithValue }) => {
    try {
      const response = await api.post(`/feedback/${courseId}`, data);
      return response.data;
    } catch (error) {
      return rejectWithValue(
